        ...
        <div class="px-4 py-6 sm:px-0">
          ...
          <div class="bg-white rounded-lg shadow">
            <div class="p-6">
              ...
              <div class="space-y-4">
                <div v-for="(activity, index) in recentActivities" :key="index" class="flex items-center py-3 border-b border-gray-200">
                  <div class="flex-1">
                    <p class="text-sm font-medium text-gray-900">{{ activity.title }}</p>
                    <p class="text-sm text-gray-500">{{ activity.time }}</p>
                  </div>
                  <span :class="activity.statusColor" class="px-3 py-1 rounded-full text-sm">
                    {{ activity.status }}
                  </span>
                </div>
              </div>
